...
#include "ble.h" // Add a reference to your module supporting scheduler events for display update
...
#warning "gpioEnableDisplay is not implemented, please implement in order to use the display"
	...
	//Command to set up Gecko soft timer
	BTSTACK_CHECK_RESPONSE(gecko_cmd_hardware_set_soft_timer(32768, 1, 0));
#else
